pub mod background {
    ...
    impl Background<'_> {
        ...
        fn draw(&mut self, canvas: &mut Canvas<Window>) {
            ...
            let result =
                canvas.with_texture_canvas(&mut self.background_texture, |texture_canvas| {
    ...
    // on pourrrait mnt changer le fond, l'écartement entre les lignes...
    //toutes ces propriétés seraient contenues dans notre background
}
